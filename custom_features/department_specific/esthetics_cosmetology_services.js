    ...
    <div style="padding: 10px;">
      ...
      <div v-if="menu == 'completed'">
        ...
        <div v-for="service in services">
          <div v-if="(service.service === selectedCompletedCriterion || service.service === '') && (completedCriterionDate === '' || completedCriterionDate === service.dateToStrnig(service.canvas_data.created_at))" style="border: 1px solid #000; padding: 20px; margin-bottom: 20px;">
